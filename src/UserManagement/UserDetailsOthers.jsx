...
const UserDetailsOthers = () => {
  const navigate = useNavigate();
  const [students, setStudents] = useState([]);
  const handleBack = () => {
    window.history.back(); // Navigate back to the previous page
  };
  const goToMentor = () => { navigate('/mentor') };
    ...
    <>
      ...
      <Container style={{ marginLeft: '320px', marginTop: '-26px', padding: '10px', background: 'white', borderRadius: '10px', maxWidth: '1070px', boxShadow: '0px 4px 8px rgba(0, 0, 0, 0.1)' }}>
        <Row className="align-items-center mb-3">
          <Col >
            <h2 style={{ fontSize: '24px', color: '#58a4b0', textAlign: 'left' }}>All Others</h2>
          </Col>
...
export default UserDetailsOthers;
