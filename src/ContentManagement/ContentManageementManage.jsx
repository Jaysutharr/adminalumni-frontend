...
const ContentManageementManage = () => {
            ...
            >
              ...
              ></FaSearch> */}
                ...
                <Row className="fw-bold border-bottom py-2 text-center" >
                    <Col xs={12} sm={6} md={3} lg={2}>Job Tittle</Col>
                ...
                >
                    {events.map((event, index) => (
                        <Row
                            ...
                            <Col xs={12} sm={6} md={3} lg={2}>{event.dateTime}</Col>
                            <Col xs={12} sm={6} md={3} lg={2}>{event.type}</Col>
                            <Col xs={12} sm={6} md={3} lg={2}>{event.attendees}</Col>
                            <Col xs={12} sm={6} md={3} lg={2}>{event.status}</Col>
...
export default ContentManageementManage;
